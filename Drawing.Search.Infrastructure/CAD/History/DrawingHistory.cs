...
namespace Drawing.Search.Infrastructure.CAD.History;
...
public class DrawingHistory
{
    ...
    private bool ViewSizesDifferent(DrawingState drawingState)
    {
        ...
        if (currViews.Count == 1 && prevViews.Count == 1)
        {
            ...
            ViewHasDifference = Math.Abs((double)(currDimensions.Item1 - prevDimensions.Item1)) > 0.0001 ||
                                Math.Abs((double)(currDimensions.Item2 - prevDimensions.Item2)) > 0.0001;
        ...
        ViewHasDifference = currViews.FindAll((v) =>
        {
            ...
            return Math.Abs((double)(currDimensions.Item1 - prevDimensions.Item1)) > 0.0001 ||
                   Math.Abs((double)(currDimensions.Item2 - prevDimensions.Item2)) > 0.0001;
        }).Count > 0;
    ...
    private bool CountDifferent(DrawingState drawingState)
    {
        ...
        var difference = Math.Abs((double)(currSize - prevSize));
